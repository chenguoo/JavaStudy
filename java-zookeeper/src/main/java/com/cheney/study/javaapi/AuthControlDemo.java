...
public class AuthControlDemo implements Watcher {
  ...
  public static void main(String[] args) throws IOException, InterruptedException, KeeperException {
    zookeeper = new ZooKeeper(ZkConstants.CONNECT_STRING, 5000, new AuthControlDemo());
    ...
    ZooKeeper zooKeeper1 = new ZooKeeper(ZkConstants.CONNECT_STRING, 5000, new AuthControlDemo());
    countDownLatch.await();
